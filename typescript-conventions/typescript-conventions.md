...
when: >-
  Load when writing or reviewing TypeScript code, especially when defining
  types, interfaces, components with props, or working with type
  transformations. Always load for .type.ts files.
rules:
  - '**/*.ts'
  - '**/*.tsx'
  - '**/*.type.ts'
