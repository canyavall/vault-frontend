...
when: >-
  Use when designing or refactoring custom hooks, determining hook complexity
  levels, deciding whether to extract logic into separate hooks, or managing
  form/query patterns in React or similar frameworks.
rules:
  - '**/*.hook.ts'
  - '**/*.hook.tsx'
  - '**/hooks/**/*.ts'
